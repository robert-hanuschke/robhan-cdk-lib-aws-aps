...
func (j *jsiiProxy_RuleGroupsNamespace) Env() *interfaces.ResourceEnvironment {
...
func (r *jsiiProxy_RuleGroupsNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
